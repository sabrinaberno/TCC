...
\begin{itemize}
    \item \textbf{OE1}: Expandir, Processar e Analisar os Dados para Predição de Ploidia
    \item \textbf{OE2}: Treinar e Ajustar o Modelo de Machine Learning para Predição de Euploidia. 
    \item \textbf{OE3}: Realizar Avaliação do Modelo 
    \item \textbf{OE4}: Construir Protótipo
\end{itemize}
...
\textbf{Capítulo 2}, intitulado "Fundamentação Teórica", apresenta os principais conceitos que fundamentam a contextualização deste estudo.
...
\textbf{Capítulo 5}, intitulado "Conclusões e Trabalhos Futuros", expõe os avanços e resultados obtidos durante o período de desenvolvimento deste TCC.
