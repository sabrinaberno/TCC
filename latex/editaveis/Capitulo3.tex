...
\begin{table}[h!]
  ...
  \caption{\scriptsize Fase 1: Análise e Preparação de Dados}
  \label{tab:fase1}
  \resizebox{\textwidth}{!}{ 
...
\begin{table}[h!]
  \centering
  \renewcommand{\arraystretch}{1.0} 
  \caption{\scriptsize Fase 2: Desenvolvimento e Avaliação do Modelo}
  \label{tab:fase2}
  \resizebox{\textwidth}{!}{ 
    \begin{tabular}{|p{3cm}|p{4cm}|p{3cm}|p{5cm}|} 
      ...
      \vspace{0.2cm} \parbox[t]{\linewidth}{\textcolor[HTML]{133E78}{\textbf{Atividade 5 (A5)}} \\ Selecionar e configurar modelos, realizando treinamento, validação e teste} \vspace{0.2cm} & 
      ...
      \vspace{0.2cm} Python (Bibliotecas scikit-learn e pandas) \vspace{0.2cm} & 
