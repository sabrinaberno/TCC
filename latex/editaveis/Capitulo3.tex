...
\includepdf{figuras/TabelaF1.pdf}

% \begin{figure}[h]
%     \centering
%     \includepdf[pages=-]{figuras/TabelaF1.pdf}
%     \caption{Tabela da Fase 1}
%     \label{resultado_pgt}
% \end{figure}
...
\begin{itemize}
    ...
    \begin{itemize}
      \item \textbf{Detalhamento da Execução:} 
      \begin{itemize}
        \item As variáveis numéricas são normalizadas, por meio de uma técnica de normalização, o Z-Score, assegurando os intervalos de valores de cada coluna. 
      \end{itemize}
...
\includepdf{figuras/TabelaF2.pdf}

% \begin{figure}[h]
%     \centering
%     \includepdf[pages=-]{figuras/TabelaF2.pdf}
%     \caption{Tabela da Fase 2}
%     \label{resultado_pgt}
% \end{figure}
