...
\begin{table}[h!]
  ...
  \resizebox{\textwidth}{!}{ 
    \begin{tabular}{|p{3cm}|p{4cm}|p{3cm}|p{5cm}|} 
      ...
      \vspace{0.2cm} \parbox[t]{\linewidth}{\textcolor[HTML]{133E78}{\textbf{Atividade 5 (A5)}} \\ Desenvolvimento e Treinamento do Modelo de Machine Learning para Otimização da Predição de Euploidia} \vspace{0.2cm} & 
