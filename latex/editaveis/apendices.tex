...
Os valores do coeficiente de Spearman variam entre -1 e +1. Utilizaremos esses valores para interpretar a força e a direção da relação entre as variáveis segundo \citeonline{santos2007} na tabela \ref{tab:correlacao_pearson}:
