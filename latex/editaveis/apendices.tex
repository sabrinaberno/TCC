...
\includepdf[pages=-, scale=1, pagecommand={}, fitpaper=true]{figuras/Z-Score.pdf}
...
\includepdf[pages=-, scale=1, pagecommand={}, fitpaper=true]{figuras/CoeficientedeSpearman.pdf}
